...
const Culture = (props) => {
  ...
  useEffect(() => {
    ...
    localStorage.setItem("culture", JSON.stringify(foundation));

    allData.Culture.map((ele, idx) => {
      if (idx === 0) {
        ele["answer"] = role1ans;
    ...
    if (role1ans && role2ans && role3ans && role4ans && role5ans && role6ans) {
      localStorage.setItem("culDone", JSON.stringify(true));
    } else {
      localStorage.setItem("culDone", JSON.stringify(false));
    }
          ...
          <div className="ro-mid">
            ...
            <div className="ro-mid1">
              <div className="ro-mid1-head">
                ...
                <Link to="/culture">
                  <p className={`${culComplete ? `completed` : ``} current`}>
                    Culture
                  </p>
                </Link>
                <Link to="/archi">
