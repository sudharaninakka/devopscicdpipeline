...
const Visibility = (props) => {
  ...
  const [see8, setSee8] = useState(false);
  const [see9, setSee9] = useState(false);
  const [see10, setSee10] = useState(false);
  const [see11, setSee11] = useState(false);
  const [see12, setSee12] = useState(false);
  ...
  const [role8ans, setRole8ans] = useState("");
  const [role8com, setRole8com] = useState("");
  const [role9ans, setRole9ans] = useState("");
  const [role9com, setRole9com] = useState("");
  const [role10ans, setRole10ans] = useState("");
  const [role10com, setRole10com] = useState("");
  const [role11ans, setRole11ans] = useState("");
  const [role11com, setRole11com] = useState("");
  const [role12ans, setRole12ans] = useState("");
  const [role12com, setRole12com] = useState("");
  ...
  useEffect(() => {
    ...
    try {
      ...
      var newData = JSON.parse(localStorage.getItem("visi"));
      if (newData) {
        ...
        for (let i = 0; i < newData.length; i++) {
          ...
          if (i === 0) {
            ...
            setRole8ans(jjds[0].answer);
            setRole8com(jjds[0].comment);
          } else if (i === 8) {
            setRole9ans(jjds[0].answer);
            setRole9com(jjds[0].comment);
          } else if (i === 9) {
            setRole10ans(jjds[0].answer);
            setRole10com(jjds[0].comment);
          } else if (i === 10) {
            setRole11ans(jjds[0].answer);
            setRole11com(jjds[0].comment);
          } else if (i === 11) {
            setRole12ans(jjds[0].answer);
            setRole12com(jjds[0].comment);
          }
          //console.log("sf1", newData);
        }
      }
  ...
  useEffect(() => {
    ...
    var rol8 = { answer: role8ans, comment: role8com };
    var rol9 = { answer: role9ans, comment: role9com };
    var rol10 = { answer: role10ans, comment: role10com };
    var rol11 = { answer: role11ans, comment: role11com };
    var rol12 = { answer: role12ans, comment: role12com };
    ...
    var roles8 = { role8: rol8 };
    var roles9 = { role9: rol9 };
    var roles10 = { role10: rol10 };
    var roles11 = { role11: rol11 };
    var roles12 = { role12: rol12 };
    ...
    foundation.push(roles8);
    foundation.push(roles9);
    foundation.push(roles10);
    foundation.push(roles11);
    foundation.push(roles12);

    // //console.log("2nd useEffect foundation - ", foundation);
    localStorage.setItem("visi", JSON.stringify(foundation));

    allData.Visibility.map((ele, idx) => {
      if (idx === 0) {
        ele["answer"] = role1ans;
        ...
        ele["answer"] = role8ans;
        ele["comment"] = role8com;
      } else if (idx === 8) {
        ele["answer"] = role9ans;
        ele["comment"] = role9com;
      } else if (idx === 9) {
        ele["answer"] = role10ans;
        ele["comment"] = role10com;
      } else if (idx === 10) {
        ele["answer"] = role11ans;
        ele["comment"] = role11com;
      } else if (idx === 11) {
        ele["answer"] = role12ans;
        ele["comment"] = role12com;
      }
    });
    ...
    if (
      ...
      localStorage.setItem("visiDone", JSON.stringify(true));
    } else {
      localStorage.setItem("visiDone", JSON.stringify(false));
    }
  ...
  function changing(e) {
    ...
    } else if (e.target.name === "q11") {
      if (e.target.type === "textarea") {
        setRole11com(e.target.value);
      } else {
        if (e.target.value === "1") {
          setRole11ans("1");
        } else if (e.target.value === "2") {
    ...
    } else if (e.target.name === "q12") {
      if (e.target.type === "textarea") {
        setRole12com(e.target.value);
      } else {
        if (e.target.value === "1") {
          setRole12ans("1");
        } else if (e.target.value === "2") {
          ...
          <div className="ro-mid">
            ...
            <div className="ro-mid1">
              <div className="ro-mid1-head">
                <Link to="/">
                  <p className={`${foundComplete ? `completed` : ``} `}>
                    Foundation
                  </p>
                </Link>
                <Link to="/roles">
                ...
                <Link to="/visi">
                  <p className={`${visiComplete ? `completed` : ``} current`}>
                    Visibility
                  </p>
                </Link>
                <Link to="/budget">
              ...
              <div className="ro-mid1-p">
                {allData.Visibility.map((data, idx) => {
                  var inputData = "";
                  var seeing = "";
